...
- Batch 3 in progress: Batch 3A completed 17 production definitions across 16 families, including two Entertainer source mechanics variants; Batch 3B completed 16 canonical production definitions across 16 families; Batch 3C completed 11 definitions across five source-variant families; together they map 54 official source entries as `production-batch-3`
- remaining Batch 3 work is five non-criminal source-variant families (11 expected definitions), `criminal` (12 expected definitions), plus the separately reviewed `deprogrammer` pressure case; 84 families / 95 definitions are currently production, with 7 families / 24 expected definitions remaining
