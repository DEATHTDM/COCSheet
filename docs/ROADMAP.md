...
- Batch 3 in progress: Batch 3A completed 16 canonical/fuzzy definitions across 16 families and mapped 22 official source entries as `production-batch-3`; remaining Batch 3 occupations and the separately reviewed `deprogrammer` pressure case are pending
